            ...
            <div>
                <div className="form-group">
                    ...
                    <div className="form-div">
                        ...
                        <button type="button" className="btn btn-default btn-list" onClick={this.onSubmit}>
...
class User extends React.Component{
    ...
    render(){
        return(
            <p><button className="btn btn-list" type="button" onClick={this.loadBoard}>{this.state.username}</button>
...
class Widget extends React.Component{
    ...
    constructor(props){
        ...
        this.state = {
            ...
            temp : props.weather.item.condition.temp,
